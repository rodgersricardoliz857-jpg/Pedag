!function(n, t) {
    ...
    !function(n) {
        ...
        function e(i) {
            var f = arguments, r = i, u, e;
            return [].shift.apply(f),
            e = this.each(function() {
                var o = n(this), i, e, s, h;
                if (o.is("select")) {
                    if (i = o.data("selectpicker"),
                    e = "object" == typeof r && r,
                    i) {
                        if (e)
                            for (s in e)
                                e.hasOwnProperty(s) && (i.options[s] = e[s])
                    } else
                        h = n.extend({}, t.DEFAULTS, n.fn.selectpicker.defaults || {}, o.data(), e),
                        h.template = n.extend({}, t.DEFAULTS.template, n.fn.selectpicker.defaults ? n.fn.selectpicker.defaults.template : {}, o.data().template, e.template),
                        o.data("selectpicker", i = new t(this,h));
            ...
            var i = {}.toString
              ...
              , t = function(n) {
                ...
                var f = u.length
                  ...
                  , t = o ? Number(o) : 0;
                return t != t && (t = 0),
                s = Math.min(Math.max(t, 0), f),
                !(h + s > f) && r.call(u, e, t) != -1
            };
        ...
        n.valHooks.select.set = function(t, r) {
            return r && !i.useDefault && n(t).data("selected", !0),
        ...
        var s = function(n) {
          ...
          , t = function(r, u) {
            i.useDefault || (n.valHooks.select.set = i._set,
            i.useDefault = !0);
            this.$element = n(r);
        ...
        t.prototype = {
            ...
            createView: function() {
                var n = this.createDropdown()
                  , t = this.createLi();
                return n.find("ul")[0].innerHTML = t,
                n
            },
            reloadLi: function() {
                var n = this.createLi();
            ...
            createLi: function() {
                var t = this, i = [], o = 0, s = document.createElement("option"), u = -1, e = function(n, t, i, r) {
                ...
                return !this.options.title || this.multiple || (u--,
                this.$element.find(".bs-title-option").length) || (h = this.$element[0],
                s.className = "bs-title-option",
                s.innerHTML = this.options.title,
                s.value = "",
                h.insertBefore(s, h.firstChild),
                a = n(h.options[h.selectedIndex]),
                void 0 === a.attr("selected") && void 0 === this.$element.data("selected") && (s.selected = !0)),
                l = this.$element.find("option"),
                l.each(function(f) {
                    var s = n(this), tt, it, w, b;
                    if (u++,
                    !s.hasClass("bs-title-option")) {
                        var a, k = this.className || "", d = r(this.style.cssText), v = s.data("content") ? s.data("content") : s.html(), g = s.data("tokens") ? s.data("tokens") : null, ft = "undefined" != typeof s.data("subtext") ? '<small class="text-muted">' + s.data("subtext") + "<\/small>" : "", y = "undefined" != typeof s.data("icon") ? '<span class="' + t.options.iconBase + " " + s.data("icon") + '"><\/span> ' : "", h = s.parent(), nt = "OPTGROUP" === h[0].tagName, ut = nt && h[0].disabled, p = this.disabled || ut;
                        if ("" !== y && p && (y = "<span>" + y + "<\/span>"),
                        t.options.hideDisabled && (p && !nt || ut))
                            return a = s.data("prevHiddenIndex"),
                            s.next().data("prevHiddenIndex", void 0 !== a ? a : f),
                            void u--;
                        if (s.data("content") || (v = y + '<span class="text">' + v + ft + "<\/span>"),
                        nt && s.data("divider") !== !0) {
                            if (t.options.hideDisabled && p && (void 0 === h.data("allOptionsDisabled") && (tt = h.children(),
                            h.data("allOptionsDisabled", tt.filter(":disabled").length === tt.length)),
                            h.data("allOptionsDisabled")))
                                return void u--;
                            if (it = " " + h[0].className || "",
                            0 === s.index()) {
                                o += 1;
                                ...
                                0 !== f && i.length > 0 && (u++,
                                i.push(e("", null, "divider", o + "div")));
                                u++;
                                i.push(e(rt, null, "dropdown-header" + it, o))
                            }
                            if (t.options.hideDisabled && p)
                                return void u--;
                            i.push(e(c(v, "opt " + k + it, d, g), f, "", o))
                        } else
                            s.data("divider") === !0 ? i.push(e("", f, "divider")) : s.data("hidden") === !0 ? (a = s.data("prevHiddenIndex"),
                            s.next().data("prevHiddenIndex", void 0 !== a ? a : f),
                            i.push(e(c(v, k, d, g), f, "hidden is-hidden"))) : (w = this.previousElementSibling && "OPTGROUP" === this.previousElementSibling.tagName,
                            !w && t.options.hideDisabled && (a = s.data("prevHiddenIndex"),
                            void 0 !== a) && (b = l.eq(a)[0].previousElementSibling,
                            b && "OPTGROUP" === b.tagName && !b.disabled && (w = !0)),
                            w && (u++,
                            i.push(e("", null, "divider", o + "div"))),
                            i.push(e(c(v, k, d, g), f)));
                        t.liObj[f] = u
                    }
                }),
            ...
            render: function(t) {
                var s, i = this, e = this.$element.find("option"), r, u, f, o, h;
                ...
                r = e.map(function() {
                    if (this.selected) {
                        ...
                        return r = i.options.showSubtext && t.data("subtext") && !i.multiple ? ' <small class="text-muted">' + t.data("subtext") + "<\/small>" : "",
                        "undefined" != typeof t.attr("title") ? t.attr("title") : t.data("content") && i.options.showContent ? t.data("content").toString() : u + t.html() + r
                    }
                }).toArray();
                u = this.multiple ? r.join(this.options.multipleSeparator) : r[0];
                this.multiple && this.options.selectedTextFormat.indexOf("count") > -1 && (f = this.options.selectedTextFormat.split(">"),
                (f.length > 1 && r.length > f[1] || 1 == f.length && r.length >= 2) && (s = this.options.hideDisabled ? ", [disabled]" : "",
                o = e.not('[data-divider="true"], [data-hidden="true"]' + s).length,
                h = "function" == typeof this.options.countSelectedText ? this.options.countSelectedText(r.length, o) : this.options.countSelectedText,
                u = h.replace("{0}", r.length.toString()).replace("{1}", o.toString())));
            ...
            setSize: function() {
                ...
                this.options.size !== !1) {
                    var r, k, f, a, e, s, h, v, i = this, t = this.$menu, d = this.$menuInner, o = n(window), ft = this.$newElement[0].offsetHeight, g = this.$newElement[0].offsetWidth, nt = this.sizeInfo.liHeight, y = this.sizeInfo.headerHeight, p = this.sizeInfo.searchHeight, w = this.sizeInfo.actionsHeight, b = this.sizeInfo.doneButtonHeight, et = this.sizeInfo.dividerHeight, c = this.sizeInfo.menuPadding, u = this.sizeInfo.menuExtras, tt = this.options.hideDisabled ? ".disabled" : "", it = function() {
                        var t, f = i.$newElement.offset(), u = n(i.options.container), r;
                        i.options.container && !u.is("body") ? (t = u.offset(),
                        t.top += parseInt(u.css("borderTopWidth")),
                        t.left += parseInt(u.css("borderLeftWidth"))) : t = {
                            top: 0,
                            left: 0
                        };
                    ...
                    (it(),
                    "auto" === this.options.size) ? (l = function() {
                        ...
                        }, rt = i.$menuInner[0].getElementsByTagName("li"), l = Array.prototype.filter ? Array.prototype.filter.call(rt, tt("hidden", !1)) : i.$lis.not(".hidden"), ut = Array.prototype.filter ? Array.prototype.filter.call(l, tt("dropdown-header", !0)) : l.filter(".dropdown-header");
                        it();
                        r = s - u.vert;
                        k = v - u.horiz;
                        i.options.container ? (t.data("height") || t.data("height", t.height()),
                        f = t.data("height"),
                        t.data("width") || t.data("width", t.width()),
                        a = t.data("width")) : (f = t.height(),
                        a = t.width());
                    ...
                    o.off("resize.getSize scroll.getSize").on("resize.getSize scroll.getSize", l)) : this.options.size && "auto" != this.options.size && this.$lis.not(tt).length > this.options.size && (rt = this.$lis.not(".divider").not(tt).children().slice(0, this.options.size).last().parent().index(),
                    ut = this.$lis.slice(0, rt + 1).filter(".divider").length,
                    r = nt * this.options.size + ut * et + c.vert,
                    i.options.container ? (t.data("height") || t.data("height", t.height()),
                    f = t.data("height")) : f = t.height(),
                    i.options.dropupAuto && this.$newElement.toggleClass("dropup", e > s && r - u.vert < f),
                    t.css({
            ...
            selectPosition: function() {
                ...
                var u, i, f, t = this, r = n(this.options.container), e = function(n) {
            ...
            setSelected: function(n, t, i) {
                ...
                i = this.findLis().eq(this.liObj[n]));
            ...
            clickListener: function() {
                ...
                this.$button.on("keyup", function(n) {
                    /(32)/.test(n.keyCode.toString(10)) && i.data("spaceSelect") && (n.preventDefault(),
                    i.data("spaceSelect", !1))
                });
                this.$button.on("click", function() {
                    t.setSize()
                ...
                this.$element.on("shown.bs.select", function() {
                    ...
                    if (t.options.liveSearch || t.multiple) {
                        if (!t.multiple) {
                            if (i = t.liObj[t.$element[0].selectedIndex],
                            "number" != typeof i || t.options.size === !1)
                                return;
                ...
                this.$menuInner.on("click", "li a", function(i) {
                    var h = n(this), o = h.parent().data("originalIndex"), nt = t.$element.val(), tt = t.$element.prop("selectedIndex"), a = !0, p, w, g;
                    if (t.multiple && 1 !== t.options.maxOptions && i.stopPropagation(),
                    i.preventDefault(),
                    !t.isDisabled() && !h.parent().hasClass("disabled")) {
                        ...
                        if (t.multiple) {
                            if ((e.prop("selected", !v),
                            t.setSelected(o, !v),
                            h.blur(),
                            r !== !1 || f !== !1) && (p = r < c.filter(":selected").length,
                            w = f < y.find("option:selected").length,
                            r && p || f && w))
                                if (r && 1 == r)
                                    c.prop("selected", !1),
                                    e.prop("selected", !0),
                                    ...
                                    e.prop("selected", !0),
                                    g = h.parent().data("optgroup"),
                                    t.$menuInner.find('[data-optgroup="' + g + '"]').removeClass("selected"),
                                    t.setSelected(o, !0);
                                else {
                                    ...
                                    s[2] && (k = k.replace("{var}", s[2][r > 1 ? 0 : 1]),
                                    d = d.replace("{var}", s[2][f > 1 ? 0 : 1]));
                                    e.prop("selected", !1);
                                    t.$menu.append(l);
                                    r && p && (l.append(n("<div>" + k + "<\/div>")),
                                    a = !1,
                                    t.$element.trigger("maxReached.bs.select"));
                                    f && w && (l.append(n("<div>" + d + "<\/div>")),
                                    a = !1,
                        ...
                        a && (nt != t.$element.val() && t.multiple || tt != t.$element.prop("selectedIndex") && !t.multiple) && (u = [o, e.prop("selected"), v],
                ...
                this.$menu.on("click", "li.disabled a, .popover-title, .popover-title :not(.close)", function(i) {
                    ...
                    i.stopPropagation(),
                    t.options.liveSearch && !n(i.target).hasClass("close") ? t.$searchbox.focus() : t.$button.focus())
                });
            ...
            liveSearchListener: function() {
                ...
                this.$searchbox.on("input propertychange", function() {
                    ...
                    i.remove(),
                    t.$searchbox.val()) && (e = t.$lis.not(".is-hidden, .divider, .dropdown-header"),
                    (o = t.options.liveSearchNormalize ? e.not(":a" + t._searchStyle() + '("' + f(t.$searchbox.val()) + '")') : e.not(":" + t._searchStyle() + '("' + t.$searchbox.val() + '")'),
                    o.length === e.length) ? (i.html(t.options.noneResultsText.replace("{0}", '"' + r(t.$searchbox.val()) + '"')),
                    t.$menuInner.append(i),
                    t.$lis.addClass("hidden")) : (o.addClass("hidden"),
                    s = t.$lis.not(".hidden"),
                    s.each(function(t) {
                        var i = n(this);
                        i.hasClass("divider") ? void 0 === u ? i.addClass("hidden") : (u && u.addClass("hidden"),
                        u = i) : i.hasClass("dropdown-header") && s.eq(t + 1).data("optgroup") !== i.data("optgroup") ? i.addClass("hidden") : u = null
                    }),
                    u && u.addClass("hidden"),
            ...
            changeAll: function(t) {
                ...
                if (this.multiple) {
                    ...
                    if (t) {
                        ...
                        return;
                    for (i.toggleClass("selected", t),
                    r = 0; r < o; r++)
                        f = i[r].getAttribute("data-original-index"),
                        u[u.length] = e.eq(f)[0];
                    n(u).prop("selected", t);
                    this.render(!1);
                    this.togglePlaceholder();
            ...
            keydown: function(t) {
                var r, u, h, e, o = n(this), y = o.is("input") ? o.parent().parent() : o.parent(), i = y.data("this"), l = ":not(.disabled, .hidden, .dropdown-header, .divider)", a = {
                    32: " ",
                    48: "0",
                    49: "1",
                    50: "2",
                ...
                if (e = i.$newElement.hasClass("open"),
                !e && (t.keyCode >= 48 && t.keyCode <= 57 || t.keyCode >= 96 && t.keyCode <= 105 || t.keyCode >= 65 && t.keyCode <= 90))
                    return i.options.container ? i.$button.trigger("click") : (i.setSize(),
                    i.$menu.parent().addClass("open"),
                    e = !0),
                    void i.$searchbox.focus();
                if (i.options.liveSearch && /(^9$|27)/.test(t.keyCode.toString(10)) && e && (t.preventDefault(),
                t.stopPropagation(),
                i.$menuInner.click(),
                i.$button.focus()),
                /(38|40)/.test(t.keyCode.toString(10))) {
                    ...
                    38 == t.keyCode ? (!i.options.liveSearch && u != h || u == -1 || u--,
                    u < 0 && (u += r.length)) : 40 == t.keyCode && ((i.options.liveSearch || u == h) && u++,
                    u %= r.length);
                    i.$menuInner.data("prevIndex", u);
                    i.options.liveSearch ? (t.preventDefault(),
                    o.hasClass("dropdown-toggle") || (r.removeClass("active").eq(u).addClass("active").children("a").focus(),
                    o.focus())) : r.eq(u).children("a").focus()
                } else
                    o.is("input") || (s = [],
                    r = i.$lis.filter(l),
                    r.each(function(i) {
                    ...
                    f = n(document).data("keycount"),
                    f++,
                    n(document).data("keycount", f),
                    v = n.trim(n(":focus").text().toLowerCase()).substring(0, 1),
                    v != a[t.keyCode] ? (f = 1,
                    n(document).data("keycount", f)) : f >= s.length && (n(document).data("keycount", 0),
                    f > s.length && (f = 1)),
                    r.eq(s[f - 1]).children("a").focus());
                (/(13|32)/.test(t.keyCode.toString(10)) || /(^9$)/.test(t.keyCode.toString(10)) && i.options.selectOnTab) && e && ((/(32)/.test(t.keyCode.toString(10)) || t.preventDefault(),
                i.options.liveSearch) ? /(32)/.test(t.keyCode.toString(10)) || (i.$menuInner.find(".active a").click(),
                o.focus()) : (c = n(":focus"),
                c.click(),
                c.focus(),
                t.preventDefault(),
                ...
                (/(^9$|27)/.test(t.keyCode.toString(10)) && e && (i.multiple || i.options.liveSearch) || /(27)/.test(t.keyCode.toString(10)) && !e) && (i.$menu.parent().removeClass("open"),
