!function(n, t) {
    ...
    function oi(n, t, r) {
        ...
        }) : er.test(t) ? i.filter(t, n, r) : (t = i.filter(t, n),
        i.grep(n, function(n) {
    ...
    function rt(n, t, u, e) {
        ...
        if (v && (l = iu(t, n[0].ownerDocument, !1, n, e),
        p = l.firstChild,
        1 === l.childNodes.length && (l = p),
        p || e)) {
            for (c = i.map(o(l, "script"), ae),
            a = c.length; h < v; h++)
                s = l,
                h !== k && (s = i.clone(s, !0, !0),
    ...
    function ou(n, t, r) {
        for (var u, e = t ? i.filter(t, n) : n, f = 0; null != (u = e[f]); f++)
            ...
            u.parentNode && (r && i.contains(u.ownerDocument, u) && hi(o(u, "script")),
    ...
    function lt(n, t, r) {
        ...
        !f.pixelMarginRight() && li.test(u) && su.test(t) && (o = e.width,
        s = e.minWidth,
        h = e.maxWidth,
    ...
    function yu(n) {
        var t = i.cssProps[n];
        return t || (t = i.cssProps[n] = be(n) || n),
        t
    }
    function pu(n, t, i) {
        var r = ct.exec(t);
    ...
    function bu(n, t, r) {
        ...
        return li.test(u) ? u : (o = s && (f.boxSizingReliable() || u === n.style[t]),
    ...
    function a(n, t, r) {
        var e, o, s = 0, l = a.prefilters.length, f = i.Deferred().always(function() {
            ...
            if (o)
                return !1;
            for (var s = ut || gu(), t = Math.max(0, u.startTime + u.duration - s), h = t / u.duration || 0, i = 1 - h, r = 0, e = u.tweens.length; r < e; r++)
                u.tweens[r].run(i);
            return f.notifyWith(n, [u, i, t]),
            i < 1 && e ? t : (e || f.notifyWith(n, [u, 1, 0]),
            f.resolveWith(n, [u]),
            !1)
        }, u = f.promise({
            elem: n,
        ...
        u--); u < c; u++)
            if (null != (e = arguments[u]))
                for (f in e)
                    r = n[f],
                    t = e[f],
                    n !== t && (h && t && (i.isPlainObject(t) || (o = Array.isArray(t))) ? (o ? (o = !1,
                    s = r && Array.isArray(r) ? r : []) : s = r && i.isPlainObject(r) ? r : {},
    ...
    i.each({
        ...
        i.fn[n] = function(r, u) {
            ...
            this.length > 1 && (lr[n] || i.uniqueSort(f),
            cr.test(n) && f.reverse()),
            this.pushStack(f)
        }
    });
        ...
        var e, r, h, u, t = [], o = [], f = -1, c = function() {
            ...
            h = e = !0; o.length; f = -1)
                for (r = o.shift(); ++f < t.length; )
                    t[f].apply(r[0], r[1]) === !1 && n.stopOnFalse && (f = t.length,
                    r = !1);
            n.memory || (r = !1);
            e = !1;
            u && (t = r ? [] : "")
    ...
    i.extend({
                            ...
                            var s = this
                              ...
                              , l = function() {
                                ...
                                if (!(t < e)) {
                                    ...
                                    i.isFunction(c) ? f ? c.call(n, o(e, r, nt, f), o(e, r, pt, f)) : (e++,
                                    c.call(n, o(e, r, nt, f), o(e, r, pt, f), o(e, r, nt, r.notifyWith))) : (u !== nt && (s = void 0,
                                    h = [n]),
                                    (f || r.resolveWith)(s, h))
                                }
                            }
        ...
        when: function(n) {
            ...
            if (f <= 1 && (vr(n, r.done(o(t)).resolve, r.reject, !f),
    ...
    ht.prototype = {
        ...
        remove: function(n, t) {
            ...
            if (void 0 !== r) {
                if (void 0 !== t)
                    for (Array.isArray(t) ? t = t.map(i.camelCase) : (t = i.camelCase(t),
    ...
    i.extend({
        ...
        style: function(n, t, r, u) {
            if (n && 3 !== n.nodeType && 8 !== n.nodeType && n.style) {
                ...
                void 0 === r ? o && "get"in o && void 0 !== (e = o.get(n, !1, u)) ? e : h[t] : (s = typeof r,
                "string" === s && (e = ct.exec(r)) && e[1] && (r = kr(n, t, e),
                s = "number"),
                null != r && r === r && ("number" === s && (r += e && e[3] || (i.cssNumber[c] ? "" : "px")),
    ...
    i.each(["height", "width"], function(n, t) {
        i.cssHooks[t] = {
            get: function(n, r, u) {
                if (r)
                    return !pe.test(i.css(n, "display")) || n.getClientRects().length && n.getBoundingClientRect().width ? bu(n, t, u) : br(n, we, function() {
                        return bu(n, t, u)
                    })
            },
            set: function(n, r, u) {
    ...
    i.cssHooks.marginLeft = hu(f.reliableMarginLeft, function(n, t) {
        if (t)
            return (parseFloat(lt(n, "marginLeft")) || n.getBoundingClientRect().left - br(n, {
                marginLeft: 0
            }, function() {
    ...
    i.Animation = i.extend(a, {
        tweeners: {
            "*": [function(n, t) {
                ...
                return kr(i.elem, n, ct.exec(t), i),
                i
            }
            ]
        },
    ...
    i.extend({
        attr: function(n, t, r) {
            ...
            if (3 !== e && 8 !== e && 2 !== e)
                return "undefined" == typeof n.getAttribute ? i.prop(n, t, r) : (1 === e && i.isXMLDoc(n) || (f = i.attrHooks[t.toLowerCase()] || (i.expr.match.bool.test(t) ? tf : void 0)),
    ...
    i.fn.extend({
        val: function(n) {
            ...
            this.each(function(r) {
                ...
                null == u ? u = "" : "number" == typeof u ? u += "" : Array.isArray(u) && (u = i.map(u, function(n) {
                    return null == n ? "" : n + ""
                })),
    ...
    i.extend(i.event, {
        trigger: function(t, f, e, o) {
            ...
            if (s = c = e = e || u,
            3 !== e.nodeType && 8 !== e.nodeType && !vi.test(h + i.event.triggered) && (h.indexOf(".") > -1 && (y = h.split("."),
            h = y.shift(),
            y.sort()),
            a = h.indexOf(":") < 0 && "on" + h,
            ...
            o || !l.trigger || l.trigger.apply(e, f) !== !1)) {
                if (!o && !l.noBubble && !i.isWindow(e)) {
                    ...
                    vi.test(b + h) || (s = s.parentNode); s; s = s.parentNode)
                        p.push(s),
                        c = s;
    ...
    i.extend({
        ...
        ajax: function(t, r) {
            ...
            f.data && (o += (yi.test(o) ? "&" : "?") + f.data,
            delete f.data),
            f.cache === !1 && (o = o.replace(uo, "$1"),
            p = (yi.test(o) ? "&" : "?") + "_=" + ef++ + p),
            f.url = o + p);
                ...
                send: function(u, f) {
                    ...
                    i = function(n) {
                        return function() {
                            ...
                            "abort" === n ? e.abort() : "error" === n ? "number" != typeof e.status ? f(0, "error") : f(e.status, e.statusText) : f(af[e.status] || e.status, e.statusText, "text" !== (e.responseType || "text") || "string" != typeof e.responseText ? {
                                binary: e.response
                            } : {
                                text: e.responseText
    ...
    i.parseHTML = function(n, t, r) {
        ...
        e = ei.exec(n),
        o = !r && [],
        e ? [t.createElement(e[1])] : (e = iu([n], t, o),
    ...
    i.fn.extend({
        offset: function(n) {
            ...
            if (t)
                return t.getClientRects().length ? (f = t.getBoundingClientRect(),
                r = t.ownerDocument,
                u = r.documentElement,
                e = r.defaultView,
                {
    ...
    i.each({
        ...
        i.fn[n] = function(u) {
            return v(this, function(n, u, f) {
                var e;
                return i.isWindow(n) ? e = n : 9 === n.nodeType && (e = n.defaultView),
                void 0 === f ? e ? e[t] : n[u] : void (e ? e.scrollTo(r ? e.pageXOffset : f, r ? f : e.pageYOffset) : n[u] = f)
