(function(t, e) {
    ...
    function i(t, e, i, n) {
        var r = ["opacity", e, ~~(100 * t), i, n].join("-")
          ...
          , l = s && "-" + s + "-" || "";
        return c[r] || (p.insertRule("@" + l + "keyframes " + r + "{" + "0%{opacity:" + a + "}" + o + "%{opacity:" + t + "}" + (o + .01) + "%{opacity:1}" + (o + e) % 100 + "%{opacity:" + t + "}" + "100%{opacity:" + a + "}" + "}", p.cssRules.length),
        c[r] = 1),
        r
    }
    function n(t, e) {
    ...
    function l() {
        ...
        s.prototype.opacity = function(t, e, i, n) {
            ...
            r && r.childNodes.length > e + n && (r = r.childNodes[e + n],
            r = r && r.firstChild,
            r = r && r.firstChild,
            r && (r.opacity = i))
        }
